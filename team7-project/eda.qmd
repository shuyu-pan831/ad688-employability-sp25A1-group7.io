...
write_csv(analytics_jobs, "data/analytics_jobs.csv")
...
ggplot(analytics_jobs, aes(x = salary)) +
  ...
  labs(title = "Salary Distribution of Data & Analytics Jobs",
       ...
       y = "Frequency") +
  theme_minimal()
ggsave("figures/Salary_Distribution_of_Data&Analytics_Jobs.png")
...
analytics_jobs %>%
  ...
  labs(title = "Top 10 Most Common Job Titles",
       ...
       y = "Count") +
  theme_minimal()
ggsave("figures/Top10_Most_Common_Job_Titles.png")
...
analytics_jobs %>%
  ...
  labs(title = "Top 10 In-Demand Skills for Analytics Jobs",
       ...
       y = "Count") +
  theme_minimal()
ggsave("figures/Top10_InDemand_Skills_for_Analytics_Jobs.png")
```
